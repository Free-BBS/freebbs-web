...
function circuitChallengeCatalog() {
  return [
    ...
    },
    {
      ...
      revision: 3,
      title: '第八关',
      description: '让输出跟随输入峰值，并在相邻峰值之间缓慢回落。',
      tolerance: 0.08,
      rewardElectric: 3,
    ...
    },
    {
      ...
      revision: 3,
      title: '第九关',
      description: '得到幅度降低并相对输入滞后的平滑正弦输出。',
      tolerance: 0.06,
      rewardElectric: 2,
      document: lowPass(),
    },
    {
      ...
      revision: 3,
      title: '第十关',
      description: '得到幅度降低并相对输入超前的正弦输出。',
      tolerance: 0.06,
      rewardElectric: 2,
      document: highPass(),
    },
    {
      ...
      revision: 3,
      title: '第十一关',
      description: '把方波的陡峭边沿变成连续、平滑的充放电曲线。',
      tolerance: 0.08,
      rewardElectric: 3,
      document: lowPass({
        waveform: 'pulse',
    ...
    },
    {
      ...
      revision: 3,
      title: '第十二关',
      description: '把方波的上升沿和下降沿分别变成窄的正、负脉冲。',
      tolerance: 0.08,
      rewardElectric: 3,
      document: highPass({
        waveform: 'pulse',
    ...
    },
    {
      ...
      revision: 3,
      title: '第十四关',
      description: '把正弦输入整形成上下电平对称、边沿陡峭的方波。',
      tolerance: 0.08,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第十五关',
      description: '让输出的主要重复频率变为输入频率的两倍。',
      tolerance: 0.09,
      rewardElectric: 5,
    ...
    },
    {
      ...
      revision: 3,
      title: '第十六关',
      description: '让输出由 3 kHz 分量主导，输入的 1 kHz 分量应尽量小。',
      tolerance: 0.12,
      rewardElectric: 6,
    ...
    },
    {
      ...
      revision: 3,
      title: '第十八关',
      description: '保持波形形状基本不变，同时把整条交流波形平移到目标直流电平。',
      tolerance: 0.1,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第十九关',
      description: '把方波变成比前一关更平滑、尖锐变化更少的输出。',
      tolerance: 0.09,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十二关',
      description: '复现目标中幅度突出、相位明确的 1 kHz 正弦输出。',
      tolerance: 0.09,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十三关',
      description: '把输入的 1 kHz 分量大幅压低，复现目标中的瞬态变化。',
      tolerance: 0.1,
      rewardElectric: 4,
      document: rlcNotch(),
    },
    {
      ...
      revision: 3,
      title: '第二十四关',
      description: '让输出以接近单位增益准确跟随输入波形。',
      tolerance: 0.05,
      rewardElectric: 2,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十六关',
      description: '得到幅度约为输入两倍、相位相反的输出。',
      tolerance: 0.07,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十七关',
      description: '得到幅度约为输入两倍、相位相同的输出。',
      tolerance: 0.07,
      rewardElectric: 4,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十八关',
      description: '把输入方波反相，并复现目标的高、低电平。',
      tolerance: 0.1,
      rewardElectric: 5,
    ...
    },
    {
      ...
      revision: 3,
      title: '第二十九关',
      description: '把输入方波反相，并复现另一组目标高、低电平。',
      tolerance: 0.1,
      rewardElectric: 5,
